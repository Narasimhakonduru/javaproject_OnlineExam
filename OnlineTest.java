...
class OnlineTest extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 1) {
            l.setText("Que2: Which class is available to all the classes automatically");
            jb[0].setText("Swing");
            jb[1].setText("Applet");
            jb[2].setText("Object");
        ...
        if (current == 7) {
            l.setText("Que8: Which one among these is not a function of the Object class");
        ...
        if (current == 8) {
            l.setText("Que9: Which function is not present in the Applet class");
            jb[0].setText("init");
            jb[1].setText("main");
            jb[2].setText("start");
